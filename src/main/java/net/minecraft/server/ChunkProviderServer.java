...
public class ChunkProviderServer implements IChunkProvider {
    ...
    // CraftBukkit start
    public org.bukkit.craftbukkit.util.FlatSet unloadQueue = new org.bukkit.craftbukkit.util.FlatSet();
    public Chunk emptyChunk;
    public IChunkProvider chunkProvider; // CraftBukkit
    private IChunkLoader e;
    public boolean forceChunkLoad = false; // true -> false
    public org.bukkit.craftbukkit.util.FlatLookup<Chunk> chunks = new org.bukkit.craftbukkit.util.FlatLookup<Chunk>();
